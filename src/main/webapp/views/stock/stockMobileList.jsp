...
<li> <a href="javascript:kangong.stock.stockMobileJson();"> Stock Mobile Json </a> </li>
...
<c:url var="stockMobileJsonURL" value="/stockMobile/json"></c:url>
...
kangong.stock = {
	...
	},stockMobileJson :function (){
		kangong.form.submitPost('${stockMobileJsonURL}');
	}
}
