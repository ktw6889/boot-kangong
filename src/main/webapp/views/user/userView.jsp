...
<div id="userInfoDiv" >
 ...
 <form:hidden path="id" />
  ...
  <button class="btn btn-primary" type="submit">저장</button>
	...
	var userInfoObj = {"userId":"sample@example.com","password":"1234","userName":"홍길동","age":"20","birthDate":"2000-01-01","city":"seoul","gender":"male","strsHobby":"reading"}
	...
	function saveData(){
	    ...
	    {
	        type:'post',
	        url:'${pageContext.request.contextPath}/user/saveJson',
	        dataType: "json",
