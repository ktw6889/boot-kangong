...
public class CalendarService extends CommonService {
	...
	public ScheduleVO findByGoogleEventId(String googleEventId) throws Exception {
		return sqlSession.selectOne("kangong.schedule.selectByGoogleEventId", googleEventId);
	}
}
