create table ST_SCHEDULE(
    ...
    CALENDAR_ID VARCHAR(50) COMMENT '일정 구분',
    CATEGORY VARCHAR(50) NOT NULL COMMENT 'CATEGORY',
    TITLE VARCHAR(50) NOT NULL COMMENT '제목',
    START_DATE TIMESTAMP COMMENT '시작일',
    END_DATE TIMESTAMP COMMENT '종료일',
    COMMENTS VARCHAR(100) COMMENT '일정_설명'    
)COMMENT='일정 테이블' ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
...
CREATE UNIQUE INDEX st_user_info_IDX1 ON st_user_info(USER_ID);
...
DROP TABLE ST_USER_AUTHORITIES;
...
CREATE TABLE ST_USER_AUTHORITIES (
  ...
  authority VARCHAR(50) COMMENT '권한',
  PRIMARY KEY (ID)
) COMMENT='사용자 권한 테이블' ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
